...
paru -S gamescope-session
systemctl enable gamescope@tty1.service
clear
...
paru -S gsfonts noto-fonts noto-fonts-emoji noto-fonts-extra noto-fonts-cjk ttf-twemoji-color ttf-symbola
clear

echo 'Standard GUI apps'
paru -S alacritty firefox pcmanfm-gtk3 gvfs gvfs-mtp xarchiver gedit imv mpv
clear
...
echo 'Gaming'
paru -S steam steam-tweaks proton-ge-custom-bin gamemode lib32-gamemode
