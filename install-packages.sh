...
print s 'Xorg, Intel and Amd GPU drivers'
...
print s 'Old intel drivers (only if necessary'
yay -S xf86-video-intel libva-intel-driver

print s 'Pulseaudio'
yay -S pulseaudio pulseaudio-alsa pulseaudio-jack pulseaudio-bluetooth

print s 'Better CLI tools'
yay -S neofetch htop bashtop micro calc autocutsel

print s 'WM'
yay -S bspwm sxhkd rofi picom polybar dunst wmrc flameshot

print s 'Display manager & Polkit'
yay -S lightdm lightdm-slick-greeter polkit-gnome

print s 'Fonts, icons & themes'
...
print s 'Gaming & Social'
yay -S steam discord lutris dino 
